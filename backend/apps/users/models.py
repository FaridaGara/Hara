...
class User(AbstractUser):
    ...
    organizer_description = models.CharField(max_length=1000, blank=True)
    organizer_website = models.URLField(max_length=500, blank=True)
    tax_id = models.CharField(max_length=10, blank=True)
    tax_legal_name = models.CharField(max_length=255, blank=True)
...
class LoginRateLimit(models.Model):
    # HMAC keys avoid persisting raw email addresses, phone numbers or IPs.
